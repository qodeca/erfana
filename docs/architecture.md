...
- **Prompt Template System**: CSP-compliant markdown templates with Handlebars-style syntax for context menu prompt templates sent to the CLI agent in the terminal (see [Prompt Templates](./prompts/README.md))
