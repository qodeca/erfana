...
- [About Erfana and Qodeca](./about.md) – Why Erfana is open source, how it is licensed, and who builds it
...
- [Error Codes](./error-codes.md) - Project-wide `ErrorCode` enum index (140 codes grouped by category; operator actions for the most-visible ones)
