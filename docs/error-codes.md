...
**Why this document exists**: Phase 4 introduced 6 new whisper codes (see [ADR 0001](./adrs/0001-self-host-whisper-binaries.md)); the full enum has grown to 140 codes. A single mapping table saves every future maintainer a `grep -r ErrorCode` sweep.
