...
Honest per-feature assessment of what an end user running an NSIS install of v0.19.0 gets today. Phases 0–4 are shipped; Phase 5 is narrowed to NSIS UX and Phase 6 is partially shipped.
