...
| 6 | [#167](https://github.com/qodeca/erfana/issues/167) | OPEN, in progress on `feature/windows-phase-6-polish` | Items 1/4/7 + D5/D7 done 2026-06-05; items 2/3 verified (no code change); D4 promoted to own ticket (#220); items 5/6 + parity items (#221–224) remain. `#158` reference dropped (#158 closed 2026-04-22); D6 owned by Phase 5 not Phase 6 |
