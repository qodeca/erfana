...
- [#167](https://github.com/qodeca/erfana/issues/167) — Phase 6: polish, Windows CI guard, visual baselines (#158 reference dropped; D6 owned by Phase 5). Partially shipped in v0.13.0 — items 5 and 6 are what remain
