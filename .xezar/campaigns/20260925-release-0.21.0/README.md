...
## Open pull requests
- #191 (#170 drop test:ci, from 994fb3e5), draft, head a99c2605, gate sealed. Cold review 6513c636 APPROVE; codex security fed841b8 running. After merge: leader-guide.md:150 drop test:ci.
