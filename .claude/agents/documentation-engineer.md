...
description: Expert documentation engineer for technical docs, API documentation, and developer content. MUST BE USED when creating or updating documentation. Use PROACTIVELY after any code changes, API modifications, or feature additions. Use immediately after implementing new endpoints, components, or functionality. Expert in documentation-as-code, automated generation, OpenAPI/Swagger, and creating maintainable documentation systems.
model: inherit
color: orange
---
