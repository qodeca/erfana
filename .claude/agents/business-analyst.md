...
description: Business analyst specialist. MUST BE USED for requirements gathering, stakeholder analysis, and process documentation. Use PROACTIVELY when defining features, analyzing business impact, or evaluating ROI. Use immediately after identifying business needs or before technical implementation.
model: inherit
color: yellow
---
