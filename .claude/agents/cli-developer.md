---
name: cli-developer
description: CLI development specialist. MUST BE USED for command-line tools, terminal interfaces, and developer utilities. Use PROACTIVELY when creating automation scripts, build tools, or developer workflows. Use immediately after defining tool requirements or when improving developer experience.
model: inherit
color: green
---
