...
description: Error pattern detective. MUST BE USED when any error, exception, or failure occurs in any service. Use PROACTIVELY when error rates increase, patterns emerge, or system behavior changes. Use immediately after incidents, outages, or customer complaints. Automatically correlates distributed errors and predicts cascading failures.
model: inherit
color: pink
---
