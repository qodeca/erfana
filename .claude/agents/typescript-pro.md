---
name: typescript-pro
description: MUST BE USED for every TypeScript file and type definition. Use PROACTIVELY to prevent runtime errors through compile-time type checking. Automatically reviews all code for type safety opportunities. Use immediately when defining data structures, API contracts, or component props.
model: inherit
color: red
---
