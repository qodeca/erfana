...
description: Architecture review specialist. MUST BE USED for system design validation, architectural decisions, and technology stack evaluation. Use PROACTIVELY when designing new features, modifying system architecture, or evaluating technical decisions. Use immediately after creating architectural diagrams or design documents.
model: inherit
color: blue
---
