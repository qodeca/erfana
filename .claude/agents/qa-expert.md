---
name: qa-expert
description: Quality assurance specialist. MUST BE USED before any feature release or deployment to validate quality. Use PROACTIVELY when requirements change or new features are added. Use immediately after bug reports or customer complaints. Automatically validates all acceptance criteria and quality gates.
model: inherit
color: cyan
---
