...
description: Code refactoring expert. MUST BE USED when code complexity exceeds thresholds or code smells are detected. Use PROACTIVELY during code reviews to improve structure and maintainability. Use immediately after identifying duplication, long methods, or complex logic. Automatically refactors technical debt.
model: inherit
color: purple
---
