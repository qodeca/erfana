...
- [Windows enablement](docs/windows/README.md) — Phases 0–2 closed on `windows` branch (2026-04-21); awaits `windows → develop` merge gated on Phase 1 UAT. Phases 3–6 tracked under [#164–#167](https://github.com/qodeca/erfana/issues?q=label%3Awindows+is%3Aopen). Canonical status + commit trail + merge-readiness gate: [`docs/windows/implementation-plan.md` § Status snapshot](docs/windows/implementation-plan.md). Closure plan: [`docs/windows/phase2-closure.md`](docs/windows/phase2-closure.md). Deferred items D1–D8: [`docs/windows/deferred-work.md`](docs/windows/deferred-work.md) (meta-issue [#168](https://github.com/qodeca/erfana/issues/168)). Windows-specific known issues: [`docs/known-issues.md` § Windows-specific issues](docs/known-issues.md#windows-specific-issues).
