...
- [Windows enablement](docs/windows/README.md) — Gap analysis + phased roadmap. **Phases 0–2 landed on `windows` branch (2026-04-21)**: portable scripts (#153), terminal parity (#154), test/dialog/path-portability fixes (#156, #157, #159), git allowlist + liveness (#160), reserved-filename guard with bidi-override defence (#161), LibreOffice Windows detection (#162), `flakeGuard.ts` for vitest post-teardown errors. NSIS installer builds. Phases 3–6 pending: screenshots, local Whisper, auto-updater, code signing, long-path activation (#163 deferred), polish. Canonical status: [`docs/windows/implementation-plan.md`](docs/windows/implementation-plan.md). Tracked deferrals (D1–D8): [`docs/windows/deferred-work.md`](docs/windows/deferred-work.md).
