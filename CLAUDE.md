...
- [Windows enablement](docs/windows/README.md) — Gap analysis + phased roadmap. **Phases 0–2 closed on `windows` branch (2026-04-21)**: portable scripts (#153), terminal parity (#154), test/dialog/path-portability fixes (#156, #157, #159), git allowlist + liveness (#160), reserved-filename guard with bidi-override defence (#161), LibreOffice Windows detection (#162), `flakeGuard.ts` for vitest post-teardown errors. NSIS installer builds. **Phase 3-6 tracked**: screenshots ([#164](https://github.com/qodeca/erfana/issues/164)), local Whisper ([#165](https://github.com/qodeca/erfana/issues/165)), distribution / auto-updater / signing ([#166](https://github.com/qodeca/erfana/issues/166)), polish + Windows CI guard + #158 v8 coverage fix ([#167](https://github.com/qodeca/erfana/issues/167)); long-path activation [#163](https://github.com/qodeca/erfana/issues/163) deferred. Tracked deferrals D1–D8 → meta-issue [#168](https://github.com/qodeca/erfana/issues/168) + [`docs/windows/deferred-work.md`](docs/windows/deferred-work.md). Dependabot triage + 28 security alerts → [#169](https://github.com/qodeca/erfana/issues/169). Canonical status: [`docs/windows/implementation-plan.md`](docs/windows/implementation-plan.md).
