...
Split to [`sd-021-mcp-contracts.md`](sd-021-mcp-contracts.md) §7.10 for the 500-line design-doc cap — the `GraphPortRequestSchema`/`GraphPortResponseSchema` port union, the connect/token handshake, and the `GraphMcpToolArgsSchema` / result schema #30 builds against.
