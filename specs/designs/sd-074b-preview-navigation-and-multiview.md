...
| D7 | One in-memory session partition **per view**, its name recycled after a bounded purge (v0.19.0) | `previewSessionPolicy.ts:64-66`. N previews get N isolated sessions. Shared state to reconcile is the allowlist and the toast budget (§4.5, §4.6) |
